        ...
        <SafeAreaView className="bg-secondary-200 flex-1">
            <View className="h-full w-full flex flex-col gap-4 px-6 py-6">
                ...
                <View className="flex flex-col justify-between flex-1">
                    ...
                    <TouchableOpacity className="border border-primary-400 rounded-full py-6 px-4 flex-row items-center justify-center gap-2" onPress={() => setIsModalVisible(true)}><Feather name="search" size={28} color="black" className="absolute left-4"/><Text className="font-brsegma-600">Add ingredients</Text></TouchableOpacity>
